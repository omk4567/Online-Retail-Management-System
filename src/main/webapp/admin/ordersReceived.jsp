...
<h3>Enter from date</h3>
 <input class="input-style" type="date" name="fromDate" placeholder="Enter from date" required>
 
  <hr>
 <h3>Enter to date</h3>
 <input class="input-style" type="date" name="toDate" placeholder="Enter to date" required>
 <hr>
...
try
{
	...
	ResultSet rs=st.executeQuery("select *from cart inner join product where cart.product_id=product.id and cart.orderDate between '"+fromDate+"' and '"+toDate+"' and cart.status='processing'");
	while(rs.next())
	{
%>  
