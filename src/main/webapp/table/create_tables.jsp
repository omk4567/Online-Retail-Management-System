...
try
{
    ...
    //ResultSet rs=st.executeQuery("create table users(name varchar(100),email varchar(100)primary key,mobileNumber int(50),securityQuestion varchar(200),answer varchar(200),password varchar(100),address varchar(500),city varchar(100),state varchar(100),country varchar(100))");
    ...
    String q2="create table product(id int,name varchar(500),category varchar(200),price int,active varchar(10),imageFileName varchar(100),imageFileName2 varchar(100),description varchar(500))";
